...
public class LibroModelImpl extends BaseModelImpl<Libro> implements LibroModel {
	...
	public static final String TABLE_SQL_CREATE =
		"create table LIBRO_Libro (uuid_ VARCHAR(75) null,libroId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,titulo VARCHAR(200) null,escritor VARCHAR(75) null,publicacion DATE null)";
